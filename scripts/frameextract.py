...
import os, cv2, csv, numpy as np, mediapipe as mp, torch
...
def extract_features_for_app(video_path):
    ...
    for i in range(0, len(frames_arr) - window_size + 1, stride):
        win = frames_arr[i : i + window_size]
